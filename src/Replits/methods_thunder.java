...
or put them in their own variables, everything to make it easy to read.
    ...
    public static boolean getThunderBlazz(boolean available,boolean gift, int ingredient1
        ...
        // your code here
        boolean blazz1 = ingredient1==1 && ingredient2==2 && ingredient3==3;  //true
        boolean blazz2 = ingredient1==3 && ingredient2==1 && ingredient3==2;  //true

        if(available==true || gift==true || blazz1 || blazz2  ){
            return true;
        }else{
            return false;
        }
