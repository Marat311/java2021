...
warmup tasks:
	...
	3.  write a return method named addElement that can add an Inteeger  after the  last index of an integer array
			array = {1,2,3,4,5}
			element = 6;
	...
	5. create a return method named contains that accepts one interger array and one integer, returns true if the integer is contained in the array, otherwise returns false
			Ex: array = {1,2,3,4,5}
				num = 5;
...
method: function. grouping a series of code fragments
		 								 ...
		 								 MUST			   MUST
		AccessModifier    Specifier    returnType        methodName (Paremeter)  {  a series of code fragments   }
			public         static       void/DataType			      dataType
		...
		void methods: cannot return any data

		return methods: MUST return a data

		Parameter: dataType.
					we pass parameter(s) if there is any data that the methods needs in order to complete its function
